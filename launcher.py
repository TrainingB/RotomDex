...
def parse_cli_args():
    parser = argparse.ArgumentParser(description="Rotomdex Launcher - Pokemon Go Bot for Discord")
    parser.add_argument("--start","-s",help="Starts Rotomdex",action="store_true")
    parser.add_argument("--auto-restart","-r",help="Auto-Restarts Rotomdex in case of a crash.",action="store_true")
...
def run_clembot(autorestart):
    ...
    cmd = [interpreter, "rotomdex", "launcher"]
